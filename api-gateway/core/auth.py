...
class AuthHandler:
    ...
    # These two methods must be indented correctly inside the class
    def encode_token(self, user_id: str, roles: List[str], expiration_minutes: int) -> str:
...
# from pydantic import BaseModel
# from config.settings import get_settings, Settings
# from core.exceptions import UnauthorizedException, ForbiddenException # Ensure this is imported
